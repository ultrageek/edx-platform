...
from student.models import CourseEnrollmentCelebration, is_email_retired, is_username_retired
...
# TODO: Uncomment this receiver connection, once the MFE actually supports celebrations
...
def create_course_enrollment_celebration(sender, instance, created, **kwargs):
    ...
    if not REDIRECT_TO_COURSEWARE_MICROFRONTEND.is_enabled(instance.course.id):
        return
